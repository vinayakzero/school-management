import { Users, GraduationCap, School, TrendingUp, MoreVertical, CreditCard } from "lucide-react";
...
export default async function AdminDashboard() {
  ...
  const feesCollected = totalStudents * 50000;

  const recentStudents = await Student.find()
    .sort({ enrollmentDate: -1, _id: -1 })
    .limit(4)
    .lean();
