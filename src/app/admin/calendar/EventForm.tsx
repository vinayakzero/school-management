...
export default function EventForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const result = isEdit ? await updateEventAction(event._id, formData) : await createEventAction(formData);
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6">
      <AdminPageHeader
        ...
        description={isEdit ? `Update the planning details for ${event.title}.` : "Schedule holidays, exams, meetings, and key school activities from a dedicated route."}
      >
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <select name="type" value={eventType} onChange={(e) => setEventType(e.target.value)} className={inputClass}>
              ...
              {eventType === "Meeting" ? (
                <>
                  ...
                  <div>
                    ...
                    <select name="meetingMode" defaultValue={event?.meetingDetails?.meetingMode || "In Person"} className={inputClass}>
